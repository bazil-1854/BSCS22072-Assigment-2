                    ...
                    <div className="row height align-items-center justify-content-center">
                        <div className="col-lg-10">
                            <div className="generic-banner-content">
                                ...
                                <p className="text-white">It wont be a bigger problem to find one video game lover in your <br /> neighbor. Since the introduction of Virtual Game.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="section-top-border">
                        ...
                        <div className="progress-table-wrap">
                            <div className="progress-table">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="percentage">
                                        <div className="progress">
                                            <div className="progress-bar color-2" role="progressbar" style={{ width: '80%' }} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="table-row">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="percentage">
                                        <div className="progress">
                                            <div className="progress-bar color-5" role="progressbar" style={{ width: '70%' }} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="table-row">
                                    ...
                                    <div className="percentage">
                                        <div className="progress">
                                            <div className="progress-bar color-6" role="progressbar" style={{ width: '40%' }} aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="table-row">
                                ...
                                <div className="table-row">
                                    ...
                                    <div className="country"> <img src="img/elements/f8.jpg" alt="flag" />
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                        ...
                        <div className="section-top-border">
                            ...
                            <div className="row gallery-item">
                                <div className="col-md-4">
                                    <a href="img/elements/g1.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g1.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-4">
                                    <a href="img/elements/g2.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g2.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-4">
                                    <a href="img/elements/g3.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g3.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-6">
                                    <a href="img/elements/g4.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g4.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-6">
                                    <a href="img/elements/g5.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g5.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-4">
                                    <a href="img/elements/g6.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g6.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-4">
                                    <a href="img/elements/g7.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g7.jpg')` }}></div></a>
                                </div>
                                <div className="col-md-4">
                                    <a href="img/elements/g8.jpg" className="img-pop-up"><div className="single-gallery-image" style={{ background: `url('img/elements/g8.jpg')` }}></div></a>
                                </div>
                            </div>
                        </div>
                        <div className="section-top-border">
